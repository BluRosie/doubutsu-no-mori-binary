...
.create "build/obj/80B0B0.bin", 0
	...
	lui at, 0x80a4
	/*illegal*/ .word 0xc43091a8
	lui at, 0x80a4
	/*illegal*/ .word 0x46083282
	/*illegal*/ .word 0xc42491ac
	lui at, 0x80a4
	/*illegal*/ .word 0xc42891b0
	lui t9, 0x8013
	lw t9, 28476(t9)
	lh a0, 102(sp)
	...
	/*illegal*/ .word 0x4b2d1eff
	/*illegal*/ .word 0x1e5a1eff
	nop
