...
.create "build/obj/80A990.bin", 0
	...
	lui at, 0x80a4
	/*illegal*/ .word 0xc43089f8
	lui at, 0x80a4
	/*illegal*/ .word 0x46083282
	/*illegal*/ .word 0xc42489fc
	lui t8, 0x8013
	lw t8, 28476(t8)
	lui a1, 0x80a4
	sll a2, s1, 0x10
