...
.create "build/obj/822AF0.bin", 0
	...
	/*illegal*/ .word 0x0600aa30
	/*illegal*/ .word 0x0600aab0
	sltiu t6, s1, 12133
	/*illegal*/ .word 0x665f6d69
	/*illegal*/ .word 0x7a757461
