...
/* 00000080:	80a8fbe0 */	lb t0, 0xfffffbe0(a1)
/* 00000084:	80a8fbf0 */	lb t0, 0xfffffbf0(a1)
/* 00000088:	80a8fc2c */	lb t0, 0xfffffc2c(a1)
/* 0000008c:	80a8fc44 */	lb t0, 0xfffffc44(a1)
...
/* 000000d4:	80a8fc60 */	lb t0, 0xfffffc60(a1)
