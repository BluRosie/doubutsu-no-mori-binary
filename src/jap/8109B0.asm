...
/* 0000001c:	24840d9c */	addiu a0, a0, 3484
...
/* 00000300:	80a3f0e0 */	lb v1, -3872(a1)
/* 00000304:	80a3f174 */	lb v1, -3724(a1)
/* 00000308:	80a3f1bc */	lb v1, -3652(a1)
/* 0000030c:	80a3f3d0 */	lb v1, -3120(a1)
...
/* 00000354:	80a3f3e0 */	lb v1, -3104(a1)
