...
/* 00001018:	00008b01 */	/*illegal*/ .word 0x00008b01
/* 0000101c:	b440ffe7 */	sdr $zero, 0xffffffe7(v0)
/* 00001020:	ff19f651 */	sd t9, 0xfffff651(t8)
/* 00001024:	dd8fb443 */	ld t7, 0xffffb443(t4)
