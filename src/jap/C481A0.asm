.n64
.create "build/jap/C481A0.bin", 0

/* 00000000:	2005fb31 */	addi a1, $zero, -1231
/* 00000004:	ffff5141 */	/*illegal*/ .word 0xffff5141
/* 00000008:	a2236915 */	sb v1, 26901(s1)
...
/* 0000001c:	bab7923f */	swr s7, -28097(s5)
